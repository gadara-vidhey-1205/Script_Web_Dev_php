...
$mynum=mysqli_num_rows($execute_query);



for($i=1;$i<=$mynum;$i++)
{
    $mydata=mysqli_fetch_row($execute_query);
}
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><a href="https://sites.google.com/view/gadaravidhey/home" target="_blank">Google Site</a></li>
                    <li class="list-group-item"><a href="https://www.linkedin.com/in/gadara-vidhey-damjibhai-573056286" target="_blank">LinkedIn</a></li>
                    <li class="list-group-item"><a href="https://www.blog.com" target="_blank">Blog</a></li>
                    <li class="list-group-item"><a href="https://github.com/gadara-vidhey-1205" target="_blank">GitHub</a></li>
                </ul>
            </nav>
            <!-- Main content -->
            <main class="col-md-9">
                <div id="header">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <img src="images\logo.JPG" alt="Logo" width="100" class="float-right">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="dashboard-item">
                        <div id="name" class="section-title">
                            <h2>Name</h2>
                        </div>
                        <p><?php echo $mydata[1] ?></p>
                    </div>
                    <div class="dashboard-item">
                        <div id="about-me" class="section-title">
                            <h2>About Me</h2>
                        </div>
                        <p><?php echo $mydata[2] ?></p>
                    </div>
                    <div class="dashboard-item">
                        <div id="my-skillset" class="section-title">
                            <h2>My Skillset</h2>
                        </div>
                        <p><?php echo "<ul> <li> $mydata[3]</li> </ul>";
                            echo "<ul> <li> $mydata[4]</li> </ul>";
                            echo "<ul> <li> $mydata[5]</li> </ul>";                           
                        ?></p>
                    </div>
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
                            <button class="ocean-blue-button gradient-button"><a href="https://github.com/gadara-vidhey-1205/Script_Web_Dev_php/tree/main/Task_1">Task 1</a></button>
                            <button class="sunset-orange-button gradient-button"><a href="https://github.com/gadara-vidhey-1205/Script_Web_Dev_php/tree/main/Task_2">Task 2</a></button>
                            <button class="spring-green-button gradient-button"><a href="https://github.com/gadara-vidhey-1205/Script_Web_Dev_php/tree/main/Task_3">Task 3</a></button>
                            <button class="royal-purple-button gradient-button">Task 4</button>
                            <button class="ruby-red-button gradient-button">Task 5</button>
                            <button class="ruby-red-button gradient-button"><a href="https://github.com/gadara-vidhey-1205/Script_Web_Dev_php/tree/main/Array%20Script">Array</a></button>
